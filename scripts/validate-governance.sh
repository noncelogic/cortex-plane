...
require_file "docs/ops/openclaw-flow-parity-map.md"
require_file "docs/ops/working-feature-velocity-loop.md"

require_contains ".github/pull_request_template.md" "## AQS — Agent Quality System"
require_contains ".github/pull_request_template.md" "### OpenClaw convergence + velocity declaration"
...
require_contains "docs/ops/engineering-operating-contract.md" "## 6) OpenClaw flow convergence + velocity contract"
require_contains "docs/ops/openclaw-flow-parity-map.md" "Session continuity"
require_contains "docs/ops/openclaw-flow-parity-map.md" "Project Orchestrator"
require_contains "docs/ops/openclaw-flow-parity-map.md" "One-round steering default"
require_contains "docs/ops/working-feature-velocity-loop.md" "Working Feature Velocity Loop"
require_contains "docs/ops/working-feature-velocity-loop.md" "Lead-time outcome"
