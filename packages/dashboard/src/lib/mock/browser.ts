...
export function mockTabs(): BrowserTab[] {
  return [
    { id: "tab-1", title: "GitHub - cortex-plane/dashboard", url: "https://github.com/cortex-plane/dashboard", active: true },
    { id: "tab-2", title: "Stack Overflow - React useEffect cleanup", url: "https://stackoverflow.com/questions/55139386/react-useeffect-cleanup", active: false },
    { id: "tab-3", title: "MDN Web Docs - Fetch API", url: "https://developer.mozilla.org/en-US/docs/Web/API/Fetch_API", active: false },
    { id: "tab-4", title: "Tailwind CSS - Utility-First Fundamentals", url: "https://tailwindcss.com/docs/utility-first", active: false },
  ]
}
...
export function mockScreenshots(agentId: string): Screenshot[] {
  ...
  return [
    {
      id: "ss-001", agentId, timestamp: new Date(now - 15_000).toISOString(),
    ...
    {
      id: "ss-002", agentId, timestamp: new Date(now - 45_000).toISOString(),
    ...
    {
      id: "ss-003", agentId, timestamp: new Date(now - 120_000).toISOString(),
    ...
    {
      id: "ss-004", agentId, timestamp: new Date(now - 300_000).toISOString(),
    ...
    {
      id: "ss-005", agentId, timestamp: new Date(now - 600_000).toISOString(),
    ...
    {
      id: "ss-006", agentId, timestamp: new Date(now - 900_000).toISOString(),
...
export function mockBrowserEvents(): BrowserEvent[] {
  const now = Date.now()
  return [
    { id: "evt-001", type: "NAVIGATE", timestamp: new Date(now - 900_000).toISOString(), url: "https://www.google.com/search?q=react+useEffect+best+practices" },
    { id: "evt-002", type: "GET", timestamp: new Date(now - 895_000).toISOString(), url: "https://www.google.com/search?q=react+useEffect+best+practices", durationMs: 340 },
    { id: "evt-003", type: "CLICK", timestamp: new Date(now - 860_000).toISOString(), selector: "a[href*='stackoverflow.com'] h3", message: "Clicked: 'React useEffect cleanup function'" },
    { id: "evt-004", type: "NAVIGATE", timestamp: new Date(now - 858_000).toISOString(), url: "https://stackoverflow.com/questions/55139386/react-useeffect-cleanup" },
    { id: "evt-005", type: "GET", timestamp: new Date(now - 855_000).toISOString(), url: "https://stackoverflow.com/questions/55139386/react-useeffect-cleanup", durationMs: 520 },
    { id: "evt-006", type: "SNAPSHOT", timestamp: new Date(now - 600_000).toISOString(), message: "Auto-snapshot: page fully loaded" },
    { id: "evt-007", type: "CONSOLE", timestamp: new Date(now - 550_000).toISOString(), message: "[info] Cookie consent banner detected, dismissing..." },
    { id: "evt-008", type: "CLICK", timestamp: new Date(now - 540_000).toISOString(), selector: "button.js-accept-cookies", message: "Clicked: 'Accept all cookies'" },
    { id: "evt-009", type: "NAVIGATE", timestamp: new Date(now - 320_000).toISOString(), url: "https://developer.mozilla.org/en-US/docs/Web/API/Fetch_API" },
    { id: "evt-010", type: "GET", timestamp: new Date(now - 318_000).toISOString(), url: "https://developer.mozilla.org/en-US/docs/Web/API/Fetch_API", durationMs: 280 },
    { id: "evt-011", type: "CONSOLE", timestamp: new Date(now - 300_000).toISOString(), message: "[debug] Extracting code examples from documentation page" },
    { id: "evt-012", type: "ERROR", timestamp: new Date(now - 180_000).toISOString(), message: "Uncaught TypeError: Cannot read properties of undefined (reading 'json')", url: "https://developer.mozilla.org/en-US/docs/Web/API/Fetch_API" },
    { id: "evt-013", type: "NAVIGATE", timestamp: new Date(now - 120_000).toISOString(), url: "https://github.com/cortex-plane/dashboard/pulls" },
    { id: "evt-014", type: "GET", timestamp: new Date(now - 118_000).toISOString(), url: "https://github.com/cortex-plane/dashboard/pulls", durationMs: 410 },
    { id: "evt-015", type: "CLICK", timestamp: new Date(now - 60_000).toISOString(), selector: "a.js-navigation-open[data-hovercard-type='pull_request']", message: "Clicked: 'feat(dashboard): Browser observation panel (#78)'" },
    { id: "evt-016", type: "SNAPSHOT", timestamp: new Date(now - 15_000).toISOString(), message: "Manual snapshot requested by operator" },
  ]
}
